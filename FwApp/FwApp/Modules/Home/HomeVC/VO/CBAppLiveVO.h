...
@property (nonatomic, copy) NSString *channel_stream;   ///<房间号       数字(number)
@property (nonatomic, copy) NSString *ID;               ///<主播的用户id    数字(number)
@property (nonatomic, copy) NSString *hx_uid;           ///<主播环信UI
...
@property (nonatomic, copy) NSString *host_level;       ///<主播用户等级    数字(number)
...
@property (nonatomic, assign) NSInteger total_earn;       ///蜂窝比
...
@property (nonatomic, copy) NSString *is_shouhu;        ///<是否守护
@property (nonatomic, copy) NSString *is_guard;         ///<是否管理员
